...
**A homelab dashboard that keeps up with the lab.** Live cards for a hundred and thirty-seven services, boards that fill any screen, a roadmap for what you are building and a list of what needs doing again next month, in one place, on the desk, the phone and the wall.
...
[![Integrations](https://img.shields.io/badge/integrations-137-3aa0ff)](#the-services-it-speaks-to)
...
- **A hundred and thirty-seven integrations,** listed in full [further down](#the-services-it-speaks-to). Generic building blocks for everything else: a JSON API widget, a calendar that merges several sources, iframes, notes, bookmarks and a notepad you type into on the board.
